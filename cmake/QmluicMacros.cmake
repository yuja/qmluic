...
function(qmluic_target_qml_sources target)
  cmake_parse_arguments(PARSE_ARGV 1 arg "DYNAMIC_BINDING" "OUTPUT_DIRECTORY" "")
  set(qml_files ${arg_UNPARSED_ARGUMENTS})
  set(dynamic_binding ${arg_DYNAMIC_BINDING})
  ...
  if(dynamic_binding)
    ...
    list(APPEND generate_ui_opts "--dynamic-binding")
  else()
